...
def set_grid_menu(main_ui: SoilAndDustEditorMainUI):
    ...
    main_ui.grid_menu.add_grid_action.triggered.connect(lambda: open_grid_line(main_ui))
    ...
    main_ui.grid_menu.remove_grid_action.triggered.connect(lambda: remove_grid_line(main_ui))
    main_ui.grid_menu.addAction(main_ui.grid_menu.remove_grid_action)


def open_grid_line(main_ui: SoilAndDustEditorMainUI):
    main_ui.map_edit_scene.draw_gird_line()


def remove_grid_line(main_ui: SoilAndDustEditorMainUI):
    main_ui.map_edit_scene.remove_all_grid_items()
