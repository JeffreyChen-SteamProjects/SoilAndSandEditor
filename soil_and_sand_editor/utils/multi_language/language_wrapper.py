from soil_and_sand_editor.utils.multi_language.english import english_word_dict
from soil_and_sand_editor.utils.multi_language.traditional_chinese import traditional_chinese_word_dict
